# -*- coding: utf-8 -*-
"""在真实 mixed fixture 上生成 Phase 4 structured patch artifact。"""
...
OUTPUT_PATH = Path(os.environ["HST_PHASE4_PROBE_PATH"])
try:
    stats = UTILS.build_pipe_chamfer(
        source_object=SOURCE,
        radius=float(os.environ.get("HST_PHASE4_RADIUS", "0.01")),
        pipe_resolution=int(os.environ.get("HST_PHASE4_RESOLUTION", "4")),
...
summary = {
    ...
    "zero_area_faces_removed": stats.get("zero_area_faces_removed", 0),
...
print("HST_PHASE4_PATCH_PROBE=" + json.dumps(summary, ensure_ascii=False))